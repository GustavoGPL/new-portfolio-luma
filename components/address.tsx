...
export default function Address() {
  ...
  return (
    <motion.section
      ref={ref}
      className="mb-28 max-w-[45rem] text-[#534329] dark:text-[#caa266] text-center leading-8 sm:mb-10 scroll-mt-28"
    ...
    >
      ...
      <div className="p-4 bg-white rounded-md dark:bg-white/10">
